...
until the full 58-tool coverage suite below has a captured response for every
...
- `tools/list` returns exactly 58 tools.
...
log includes the initialize response, `tools/list` with 58 tools and
