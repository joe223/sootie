...
**CRITICAL RULE:** NEVER perform Git operations (commit, push, branch, merge, etc.) without explicit user permission. 
...
- Any operation that modifies Git history or remote repositories

You may ONLY perform Git operations when:
- User explicitly asks you to commit/push/etc.
- User provides a specific commit message
- User is reviewing the changes before they are committed

Always show the user what changes will be committed BEFORE asking for permission.
